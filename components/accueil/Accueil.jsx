...
function Accueil() {
  return (
    <div className="flex p-14 flex-col item-center gap-8 justify-center md:h-[calc(100vh-6rem)] lg:w-2/3 mx-auto">
      ...
      <div className="flex align-center justify-end relative mr-10">
        <Image
          src={soutien}
          width={60}
          height={60}
          alt="soutien"
          className={styles.soutien}
        />
      </div>
    </div>
  );
